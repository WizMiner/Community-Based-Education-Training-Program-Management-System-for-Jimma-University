...
@section('header')
    @include('layout.header', ['title' => 'CBE | Notice Board | Add'])
@endsection
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Add Notice Board Information</h3>
                        </div>
                        <form method="POST" action="{{ route('cbe.notice-board.store') }}">
                            @csrf
                            <div class="card-body">
                                @if (session('error'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="description" placeholder="Enter description" type="text"
